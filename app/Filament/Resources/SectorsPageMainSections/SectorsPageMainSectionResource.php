...
class SectorsPageMainSectionResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'الجزء الرئيسي';

    protected static string|\UnitEnum|null $navigationGroup = 'القطاعات';

    protected static ?string $modelLabel = 'الجزء الرئيسي';

    protected static ?string $pluralModelLabel =  'الجزء الرئيسي';
