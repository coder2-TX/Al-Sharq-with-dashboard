...
class SectorsPageAdvertisingPageResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'صفحة القطاعات - صفحة قطاع الدعاية';

    protected static string|\UnitEnum|null $navigationGroup = 'القطاعات';

    protected static ?string $modelLabel = 'صفحة القطاعات - صفحة قطاع الدعاية';

    protected static ?string $pluralModelLabel = 'صفحة القطاعات - صفحة قطاع الدعاية';
