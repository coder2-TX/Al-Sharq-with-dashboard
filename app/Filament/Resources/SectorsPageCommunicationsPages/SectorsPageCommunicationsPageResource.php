...
namespace App\Filament\Resources\SectorsPageCommunicationsPages;

use App\Filament\Resources\SectorsPageCommunicationsPages\Pages;
...
class SectorsPageCommunicationsPageResource extends Resource
{
    protected static ?string $model = SectorsPageCommunicationsPage::class;
            ...
            Section::make('الصورة الرئيسية')
                ...
                ->schema([
                    FileUpload::make('hero_image')
                        ...
                        ->image()
                        ->disk('public')
                        ->directory('site/sectors/sector-pages/communications')
                        ->visibility('public')
                        ->columnSpanFull(),
                ]),

            Section::make('النص التعريفي -  2')
                ->columnSpanFull()
                ->columns(2)
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->recordUrl(fn (SectorsPageCommunicationsPage $record): string => static::getUrl('edit', ['record' => $record]))
            ->recordActions([
                EditAction::make(),
                DeleteAction::make(),
            ])
    ...
    {
        return [
            'index' => Pages\ListSectorsPageCommunicationsPages::route('/'),
            'create' => Pages\CreateSectorsPageCommunicationsPage::route('/create'),
            'edit' => Pages\EditSectorsPageCommunicationsPage::route('/{record}/edit'),
        ];
    }
