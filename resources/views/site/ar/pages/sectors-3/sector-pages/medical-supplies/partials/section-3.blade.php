            ...
            <div class="lp-communicationsS3__row">
              ...
              <div class="lp-communicationsS3__content">
                <h3 class="lp-communicationsS3__partnerName">
                  <span class="lp-autoLatin" dir="ltr" lang="en">{{ $partner->partner_name }}</span>
                </h3>

                <div class="lp-communicationsS3__text">
                  {!! \App\Support\Text\DisplayTextFormatter::fromPlainText($partner->description_ar) !!}
                </div>
                ...
                <div class="lp-communicationsS3__actions">
                  <a
                    ...
                    href="{{ $partnerUrl }}"
                    aria-label="عرض منتجات {{ $partner->partner_name }}"
                  >
