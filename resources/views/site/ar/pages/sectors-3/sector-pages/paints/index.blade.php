@php
    ...
    $paintsHeroImage = $page?->hero_image
        ...
        : asset('assets/images/section/7.jpeg');
@endphp
...
<head>
  ...
  <title>قطاع الدهانات | شركة الشرق</title>
...
>
  ...
  <main id="paints-sector-page">
    ...
    <section
      ...
      id="paints-hero"
      aria-label="قطاع الدهانات"
      style="position: relative; overflow: hidden; isolation: isolate;"
    >
      <div
        aria-hidden="true"
        style="position:absolute; inset:0; background-image:url('{{ $paintsHeroImage }}'); background-size:cover; background-position:center; background-repeat:no-repeat; z-index:0;"
      ></div>
          ...
          <div class="lp-medicalS1__text">
            <h1 class="lp-medicalS1__title lp-sectors__title">
              <span class="lp-medicalS1__titleLine">
                قطاع <span class="lp-medicalS1__accentWord">الدهانات</span>
              </span>
            </h1>
          </div>
        </div>
    ...
    @include('site.ar.pages.sectors-3.sector-pages.paints.partials.section-2')
    @include('site.ar.pages.sectors-3.sector-pages.paints.partials.section-3')
