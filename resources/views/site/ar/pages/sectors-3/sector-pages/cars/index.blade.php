...
<head>
  ...
  <title>قطاع السيارات | شركة الشرق</title>
...
>
  ...
  <main id="cars-sector-page">
          ...
          <div class="lp-medicalS1__text">
            <h1 class="lp-medicalS1__title lp-sectors__title">
              <span class="lp-medicalS1__titleLine">
                قطاع <span class="lp-medicalS1__accentWord">السيارات</span>
              </span>
            </h1>
          </div>
        </div>
    ...
    @include('site.ar.pages.sectors-3.sector-pages.cars.partials.section-2')
    @include('site.ar.pages.sectors-3.sector-pages.cars.partials.section-3')
