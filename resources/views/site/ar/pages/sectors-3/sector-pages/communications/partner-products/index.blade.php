...
>
  ...
  <main id="communications-partner-products-page">
    @include('site.ar.pages.sectors-3.sector-pages.communications.partner-products.partials.section-1')
    @include('site.ar.pages.sectors-3.sector-pages.communications.partner-products.partials.section-2')
  </main>
