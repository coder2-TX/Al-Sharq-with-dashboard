    ...
    if ($partners->isEmpty()) {
        $partners = collect([
            (object) [
                ...
                'description_ar' => 'شريك إعلاني افتراضي تمت إضافته مؤقتاً لعرض السلايدر وصفحة المنتجات حتى يتم إدخال بيانات الشركاء الحقيقيين من لوحة التحكم.',
            ],
            (object) [
                'id' => 2,
                'partner_image' => null,
                ...
                'description_ar' => 'عنصر تجريبي لعرض شكل سكشن الشركاء وآلية الانتقال إلى صفحة منتجات الشريك ضمن قطاع الإعلانات.',
            ],
            (object) [
                'id' => 3,
                'partner_image' => null,
                ...
                'description_ar' => 'محتوى افتراضي يوضح شكل صورة الشريك والوصف وزر عرض المنتجات قبل إضافة بيانات فعلية من الداشبورد.',
            ],
            (object) [
                'id' => 4,
                'partner_image' => null,
                ...
                'description_ar' => 'شريك افتراضي آخر للتأكد من أن سلايدر الشركاء يعمل بشكل مستقل تماماً لقطاع الإعلانات.',
            ],
            (object) [
                'id' => 5,
                'partner_image' => null,
                ...
                'description_ar' => 'بيانات تجريبية مؤقتة لعرض التصميم العام لشركاء قطاع الإعلانات بنفس طريقة القطاعات الأخرى.',
            ],
            (object) [
                'id' => 6,
                'partner_image' => null,
                ...
                'description_ar' => 'عنصر افتراضي أخير للتأكد من اكتمال الربط المستقل لهذا السكشن بعيداً عن قطاع الاتصالات.',
            ],
        ]);
    }
@endphp
      ...
      <div class="lp-communicationsS3__viewport" data-slider-viewport aria-live="polite">
        @foreach ($partners as $partner)
          @php
              ...
              $partnerUrl = route('site.ar.advertising.partner-products', [
