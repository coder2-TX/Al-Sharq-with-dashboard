...
<head>
  ...
  <title>القطاع التجاري | شركة الشرق</title>
...
>
  ...
  <main id="sectors3-detail-page">
    <section class="lp-section lp-sectorsHero2" id="sectors-hero-2" aria-label="القطاع التجاري">
      <video
      ...
      <div class="lp-sectorsHero2__inner">
        <header class="lp-sectorsHero2__head">
          <h2 class="lp-sectorsHero2__title">القطاع <span class="lp-sectorsHero2__titleAccent">التجاري</span></h2>
        </header>
      </div>
    </section>

    @include('site.ar.pages.sectors-3.sector-details.commercial.partials.section-2')
  </main>
