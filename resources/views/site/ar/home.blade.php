...
@section('content')
    ...
    <main id="home">
        ...
        <section class="lp-hero" aria-label="Hero">
            <div class="lp-hero__graphics" aria-hidden="true">
            ...
            <div class="lp-hero__content">
                <div class="lp-hero__contentRow">
                    <div class="lp-hero__text">
                        <h1 class="lp-hero__title">
                            <span class="lp-hero__titleLine">شركة <span class="lp-hero__accentWord">الشرق</span></span>
                            <span class="lp-hero__titleLine">للتجارة والتوكيلات</span>
                        </h1>
                    ...
                    <a class="lp-hero__logo" href="#home" aria-label="العودة للرئيسية">
        ...
        @include('site.ar.partials.about')
        @include('site.ar.partials.iso')
        @include('site.ar.partials.sectors')
        @include('site.ar.partials.numbers')
        @include('site.ar.partials.partners')
