...
>
  ...
  <main id="medicines-partner-products-page">
    @include('site.en.pages.sectors-3.sector-pages.medicines.partner-products.partials.section-1')
    @include('site.en.pages.sectors-3.sector-pages.medicines.partner-products.partials.section-2')
  </main>
