<section class="lp-section lp-medicalPharmaS1" id="medical-pharmacovigilance-hero" aria-label="Reporting adverse drug reactions">
      ...
      <div class="lp-medicalPharmaS1__text">
        <h1 class="lp-medicalPharmaS1__title lp-sectors__title">
          <span class="lp-medicalPharmaS1__titleLine">
            <span class="lp-medicalPharmaS1__accentWord">Reporting</span>
          </span>
          <span class="lp-medicalPharmaS1__titleLine">Adverse Drug Reactions</span>
        </h1>
      </div>
    </div>
  </div>
