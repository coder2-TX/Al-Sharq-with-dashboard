@php
    ...
    $heroImage = $sectorSection?->medicines_image
        ? \Illuminate\Support\Facades\Storage::url($sectorSection->medicines_image)
...
<head>
  ...
  <title>Medicines Sector | Al Sharq Company</title>
...
>
  ...
  <main id="medicines-sector-page">

    <section
      class="lp-section lp-medicalS1"
      id="medicines-hero"
      aria-label="Medicines sector"
          ...
          <div class="lp-medicalS1__text">
            <h1 class="lp-medicalS1__title lp-sectors__title">
              <span class="lp-medicalS1__titleLine">
                Medicines <span class="lp-medicalS1__accentWord">Sector</span>
              </span>
            </h1>
          </div>
        </div>
    ...
    @include('site.en.pages.sectors-3.sector-pages.medicines.partials.section-2')
    @include('site.en.pages.sectors-3.sector-pages.medicines.partials.section-3')
    @include('site.en.pages.sectors-3.sector-pages.medicines.partials.section-4')
