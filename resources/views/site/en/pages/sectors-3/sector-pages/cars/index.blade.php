@php
    $carsHeroImage = asset('assets/images/sectors/sector-details/commercial/7.jpeg');
@endphp
...
<head>
  ...
  <title>Automotive Sector | Al Sharq Company</title>
...
<body
  class="lp-page--carsSector lp-page--medicalSector"
...
>
  ...
  <main id="cars-sector-page">

    <section
      class="lp-section lp-medicalS1"
      id="cars-hero"
      aria-label="Automotive Sector"
      style="position: relative; overflow: hidden; isolation: isolate;"
    >
      <div
        aria-hidden="true"
        style="position:absolute; inset:0; background-image:url('{{ $carsHeroImage }}'); background-size:cover; background-position:center; background-repeat:no-repeat; z-index:0;"
      ></div>
          ...
          <div class="lp-medicalS1__text">
            <h1 class="lp-medicalS1__title lp-sectors__title">
              <span class="lp-medicalS1__titleLine">
                <span class="lp-medicalS1__accentWord">Automotive</span> Sector
              </span>
            </h1>
          </div>
        </div>
    ...
    @include('site.en.pages.sectors-3.sector-pages.cars.partials.section-2')
    @include('site.en.pages.sectors-3.sector-pages.cars.partials.section-3')
