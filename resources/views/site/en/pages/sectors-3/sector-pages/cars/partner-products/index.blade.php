...
>
  ...
  <main id="cars-partner-products-page">
    @include('site.en.pages.sectors-3.sector-pages.cars.partner-products.partials.section-1')
    @include('site.en.pages.sectors-3.sector-pages.cars.partner-products.partials.section-2')
  </main>
