<section class="lp-section lp-medicalS1" id="milk-food-hero" aria-label="Infant Formula and Food Sector">
      ...
      <div class="lp-medicalS1__text">
        <h1 class="lp-medicalS1__title lp-sectors__title">
          <span class="lp-medicalS1__titleLine">
            Infant Formula &amp; <span class="lp-medicalS1__accentWord">Food</span>
          </span>
        </h1>
      </div>
    </div>
