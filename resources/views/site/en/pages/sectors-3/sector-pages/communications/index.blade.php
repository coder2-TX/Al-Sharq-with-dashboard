...
<head>
  ...
  <title>Telecommunications Sector | Al Sharq Company</title>
...
>
  ...
  <main id="communications-sector-page">
    ...
    <section
      ...
      aria-label="Telecommunications sector"
          ...
          <div class="lp-medicalS1__text">
            <h1 class="lp-medicalS1__title lp-sectors__title">
              <span class="lp-medicalS1__titleLine">
                <span class="lp-medicalS1__accentWord">Telecommunications</span> Sector
              </span>
            </h1>
          </div>
        </div>
    ...
    @include('site.en.pages.sectors-3.sector-pages.communications.partials.section-2')
    @include('site.en.pages.sectors-3.sector-pages.communications.partials.section-3')
