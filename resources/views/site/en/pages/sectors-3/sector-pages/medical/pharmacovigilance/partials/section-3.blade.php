...
<section
  ...
  id="pharma-section-3"
  aria-label="Adverse drug reaction reporting form"
>
  <div class="lp-pharmaSection3__inner">

    <header class="lp-pharmaSection3__head">
      <h2 class="lp-pharmaSection3__title">
        Reporting Adverse Drug <span class="lp-pharmaSection3__titleAccent">Reactions</span>
      </h2>
    </header>

    <form
      id="lpPharmaWhatsAppFormEn"
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const form = document.getElementById('lpPharmaWhatsAppFormEn');
    ...
    form.addEventListener('submit', function (event) {
      ...
      const lines = [
        'New report from the Pharmacovigilance page',
