@php
    ...
    $paintsHeroImage = $page?->hero_image
        ? \Illuminate\Support\Facades\Storage::url($page->hero_image)
        : asset('assets/images/sectors/sector-details/commercial/1.png');
@endphp
...
<head>
  ...
  <title>Paints Sector | Al Sharq Company</title>
...
>
  ...
  <main id="paints-sector-page">
    <section
      class="lp-section lp-medicalS1"
      id="paints-hero"
      aria-label="Paints Sector"
      style="position: relative; overflow: hidden; isolation: isolate;"
    >
      <div aria-hidden="true" style="position:absolute; inset:0; background-image:url('{{ $paintsHeroImage }}'); background-size:cover; background-position:center; background-repeat:no-repeat; z-index:0;"></div>
          ...
          <div class="lp-medicalS1__text">
            <h1 class="lp-medicalS1__title lp-sectors__title">
              <span class="lp-medicalS1__titleLine">
                <span class="lp-medicalS1__accentWord">Paints</span> Sector
              </span>
            </h1>
          </div>
        </div>
    ...
    @include('site.en.pages.sectors-3.sector-pages.paints.partials.section-2')
    @include('site.en.pages.sectors-3.sector-pages.paints.partials.section-3')
  </main>
