<section
  ...
  id="vocational-training-partner-products-hero"
  aria-label="{{ $partnerName }} Products"
  style="position: relative; overflow: hidden; isolation: isolate;"
>
  <div aria-hidden="true" style="position:absolute; inset:0; background-image:url('{{ $partnerHeroImage }}'); background-size:cover; background-position:center; background-repeat:no-repeat; z-index:0;"></div>
    ...
    <div class="lp-medicalS1__contentRow">
      <div class="lp-medicalS1__text">
        <h1 class="lp-medicalS1__title lp-sectors__title">
          <span class="lp-medicalS1__titleLine">Products</span>
