...
<head>
  ...
  <title>Commercial Sector | Al Sharq Company</title>
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/pages/sectors-3/sector-detail-section-2.css') }}" />
...
<body
  class="lp-page--sectors3 lp-page--sectors3-detail"
...
>
  ...
  <main id="sectors3-detail-page">
    <section class="lp-section lp-sectorsHero2" id="sectors-hero-2" aria-label="Commercial sector">
      <video
      ...
      <div class="lp-sectorsHero2__inner">
        <header class="lp-sectorsHero2__head">
          <h2 class="lp-sectorsHero2__title">Commercial <span class="lp-sectorsHero2__titleAccent">Sector</span></h2>
        </header>
      </div>
    </section>

    @include('site.en.pages.sectors-3.sector-details.commercial.partials.section-2')
  </main>
