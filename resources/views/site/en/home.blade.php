...
@section('content')
    ...
    <main id="home">
        ...
        <section class="lp-hero" aria-label="Hero">
            ...
            <div class="lp-hero__content">
                <div class="lp-hero__contentRow">
                    <a class="lp-hero__logo" href="/en" aria-label="Back to home">
                        <img src="{{ asset('assets/images/header/logo.png') }}" alt="Logo" />
                    </a>

                    <div class="lp-hero__text">
                        <h1 class="lp-hero__title">
                            <span class="lp-hero__titleLine">Al <span class="lp-hero__accentWord">Sharq</span></span>
                            <span class="lp-hero__titleLine">Trading & Agencies Company</span>
                        </h1>
        ...
        @include('site.en.partials.iso')
        @include('site.en.partials.sectors')
        @include('site.en.partials.numbers')
